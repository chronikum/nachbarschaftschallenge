...
@Component({
  selector: 'app-template1-component',
  templateUrl: './template1-component.component.html',
  styleUrls: ['./template1-component.component.scss']
})
export class Template1ComponentComponent implements OnInit {
