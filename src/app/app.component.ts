...
export class AppComponent {
  ...
  async getPDF() {
    ...
    const body = {
      ...
      'data': {
        'intro': 'Hallo',
        'paragraph1': 'DAS IST EIN TEST',
        'explanation': 'DAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TEST',
        'paragraph2': 'DAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TEST',
        'name': 'DAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TESTDAS IST EIN TEST',
      },
    }
